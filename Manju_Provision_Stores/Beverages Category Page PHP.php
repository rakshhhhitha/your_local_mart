...
$stmt->execute();
$BeveragesProducts = $stmt->get_result();

// Check if any rows are returned
if ($BeveragesProducts->num_rows > 0) {
    // Start HTML document
    ?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Beverages Products</title>
    ...
    <body>
        ...
        <section id="popular-product">
            ...
            <div class="product-heading">
                <h2 class='fruits-heading'>Beverages Products</h2>
            </div>
            <!--box-container------>
            <div class="product-container">
                <!--box---------->
                <?php while ($row = $BeveragesProducts->fetch_assoc()) { ?>
    ...
    // No products found in the 'BEVERAGES' category
    echo "No products found in the 'BEVERAGES' category.";
}
