...
$productCategory = 'BAKERY CAKES & DAIRY';
$stmt->bind_param("s", $productCategory);
$stmt->execute();
$BCDProducts = $stmt->get_result();

// Check if any rows are returned
if ($BCDProducts->num_rows > 0) {
    // Start HTML document
    ?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title> BAKERY CAKES & DAIRY Products</title>
    ...
    <body>
        ...
        <section id="popular-product">
            ...
            <div class="product-heading">
                <h2 class='fruits-heading'>BAKERY CAKES & DAIRY Products</h2>
            </div>
            <!--box-container------>
            <div class="product-container">
                <!--box---------->
                <?php while ($row = $BCDProducts->fetch_assoc()) { ?>
    ...
    // No products found in the 'BAKERY CAKES & DAIRY' category
    echo "No products found in the 'BAKERY CAKES & DAIRY' category.";
}
