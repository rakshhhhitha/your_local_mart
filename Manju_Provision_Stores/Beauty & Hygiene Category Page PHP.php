...
$stmt->execute();
$BNHProducts = $stmt->get_result();

// Check if any rows are returned
if ($BNHProducts->num_rows > 0) {
    // Start HTML document
    ?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title> BEAUTY & HYGIENE Products</title>
    ...
    <body>
        ...
        <section id="popular-product">
            ...
            <div class="product-heading">
                <h2 class='fruits-heading'>BEAUTY & HYGIENE Products</h2>
            </div>
            <!--box-container------>
            <div class="product-container">
                <!--box---------->
                <?php while ($row = $BNHProducts->fetch_assoc()) { ?>
    ...
    // No products found in the 'BEAUTY & HYGIENE' category
    echo "No products found in the 'BEAUTY & HYGIENE' category.";
}
